...
test_chrome_ga:
	browserName='chrome' version=43 platform='Windows 7' name=ChromeTests $(RUN_CUCUMBER_TESTS) > output_JUnit_chrome.txt
	cat output_JUnit_chrome.txt | ./node_modules/.bin/cucumber-junit > output_JUnit_chrome.xml

test_ie10:
	browserName='internet explorer' version=10 platform='Windows 7' name=IE10Tests $(RUN_CUCUMBER_TESTS) > output_JUnit_ie10.txt
	cat output_JUnit_ie10.txt | ./node_modules/.bin/cucumber-junit > output_JUnit_ie10.xml

test_firefox_ga:
	browserName='firefox' version=37 platform='Windows 7' name=FirefoxTests $(RUN_CUCUMBER_TESTS) > output_JUnit_firefox.txt
