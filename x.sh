...
browserName=firefox version=37 platform='Windows 7' ./node_modules/.bin/parallel-cucumber-js features -f json -w 8 | ./node_modules/.bin/cucumber-junit > output_JUnit_firefox.xml
